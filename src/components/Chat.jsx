...
export default function Chat() {
  ...
  return (
  <div className="fixed inset-0 top-[112px] flex overflow-hidden">
    ...
    <div className="flex flex-col flex-1 h-full">
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 md:px-6 md:py-4 space-y-4 min-h-0">
          {messages.length === 0 ? (
        ...
        <div className="px-4 py-3 md:px-6 md:py-4 border-t border-gray-200 shrink-0 bg-white">
